        ...
        <div class="row justify-content-center d-flex mt-5">
            <div class="col-md-12">
                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                        @if ($book->image != '')
                            <img width="400px" height="500px" src="{{ asset('/uploads/books/' . $book->image) }}"
                                alt="" class="card-img-top">
                        @else
                            <img width="400px" height="500px" src="https://placehold.co/500x400?text= No image"
                                alt="" class="card-img-top">
                        @endif
                                        ...
                                        <div class="card border-0 shadow-lg">
                                            @if ($relatedBook->image != '')
                                                <img width="100px" height="200px"
                                                    src="{{ asset('/uploads/books/' . $relatedBook->image) }}"
                                                    alt="" class="card-img-top">
                                            @else
                                                <img width="100px" height="200px"
                                                    src="https://placehold.co/200x100?text=No image" alt=""
                                                    class="card-img-top">
                                            @endif
    ...
    <div class="modal fade " id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="" id="book_review" name="book_review">
...
@section('script')
    <script>
        $("#book_review").submit(function(event) {
            ...
            $.ajax({
                ...
                data: $("#book_review").serializeArray(),
